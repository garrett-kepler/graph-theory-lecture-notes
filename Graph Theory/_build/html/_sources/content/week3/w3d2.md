...
It is! Try 2-coloring it. 


The way Garrett chose this graph is by tne fun result we'll prove later: "A graph is 2-colorable if and only if it has no odd-cycles". You can verify this graph has no odd-cycles (and so it is 2-colorable).
````
